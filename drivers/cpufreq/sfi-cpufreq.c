...
//+State [24]: core_frequency[333] transition_latency[100] control[0x42e] -83MHz	100	0x101
	pr->performance->states[sfi_cpufreq_num-3].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 134; //416MHz
	...
	pr->performance->states[sfi_cpufreq_num-2].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 133 - 133; //416MHz
	...
	pr->performance->states[sfi_cpufreq_num-1].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 134 - 133 - 133; //333MHz
